...
typedef _LDR_DATA_TABLE_ENTRY_T<DWORD> LDR_DATA_TABLE_ENTRY_32;
typedef _LDR_DATA_TABLE_ENTRY_T<DWORD64> LDR_DATA_TABLE_ENTRY_64;

typedef _TEB_T_<DWORD> TEB_32;
typedef _TEB_T_<DWORD64> TEB_64;

typedef _PEB_LDR_DATA_T<DWORD> PEB_LDR_DATA_32;
typedef _PEB_LDR_DATA_T<DWORD64> PEB_LDR_DATA_64;

typedef _PEB_T<DWORD, DWORD64, 34> PEB_32;
typedef _PEB_T<DWORD64, DWORD, 30> PEB_64;
